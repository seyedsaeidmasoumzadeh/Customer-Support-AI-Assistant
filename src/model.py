...
class GenerativeModel:
    ...
    def load_model(self):
        peft_model_base = AutoModelForSeq2SeqLM.from_pretrained(settings.BASE_MODEL, torch_dtype=torch.bfloat16)
    ...
    def generate_response(self, comment:str) -> List[str]:
        ...
        responses = [self.tokenizer.decode(ids, skip_special_tokens=True) for ids in output_ids]
